...
When use ABP you should enable Resets fram counters under Network Layer/advanced Mac setting
...
//ABP  NWKSKEY and APPSKEY in msb
#if defined(UNO11)
...
#if defined(UNO12) NWKSKEY and APPSKEY in msb
